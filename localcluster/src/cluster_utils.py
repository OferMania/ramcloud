...
def get_node_image():
    ...
    node_image = docker_client.images.build(path='/src/ramcloud',
                                            dockerfile='/src/ramcloud/localcluster/config/Dockerfile.node',
...
# ClusterClient Usage in Python interpreter:
